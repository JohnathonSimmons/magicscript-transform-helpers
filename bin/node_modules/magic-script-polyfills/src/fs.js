 ...
 */
let open = (path, flags, mode) => acall(fs.open, path, flags, mode);
 ...
 * @param {number} offset
 */
let write = (fd, buffer, offset) => acall(fs.write, fd, buffer, offset);
 ...
 * @param {number} offset
 */
let read = (fd, buffer, offset) => acall(fs.read, fd, buffer, offset);

/**
 * Close a file descriptor.
 * @param {number} fd
 */
let close = (fd) => acall(fs.close, fd);
 ...
 */
async function writeFileStream (path, stream, options = {}) {
 ...
 */
async function readFileStream (path, options = {}) {
...
async function expandBody (data, onBuffer) {
...
export { close, expandBody, open, read, readFileStream, write, writeFileStream };
